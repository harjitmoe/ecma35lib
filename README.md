...
|`IRR 1 G*DM4 ! 9`|GB/T 13132 (further supplementary traditional), without [IRGN2302](https://www.unicode.org/irg/docs/n2302-GSourceIssues.pdf) corrections.&ensp;The correct behaviour in relation to the IRGN2302 corrections is unclear since [the Chinese national body rejected them in IRGN2376](https://www.unicode.org/irg/docs/n2376-GSourceUpdate.pdf), and GB/T 13132 was never published (IRGN2302 references the theoretically homologous GB/T 7590).|
...
|`IRR 3 G*DM4 ! 9`|GB/T 13132 (further supplementary traditional) with [IRGN2302](https://www.unicode.org/irg/docs/n2302-GSourceIssues.pdf) corrections.&ensp;The correct behaviour with respect to the IRGN2302 corrections is unclear for the reasons mentioned above.|
