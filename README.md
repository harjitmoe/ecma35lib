...
|`IRR 0 G*DM4 ! 8`|Almost GB 7589 (supplementary simplified), based on the GB 13131 mappings without [IRGN2302](https://appsrv.cse.cuhk.edu.hk/~irg/irg/irg50/IRGN2302EddieLi.pdf) corrections&mdash;this is generated from the GB 13131 mappings, and may be minorly inaccurate in places.|
|`IRR 1 G*DM4 ! 8`|GB 13131 (supplementary traditional), without [IRGN2302](https://appsrv.cse.cuhk.edu.hk/~irg/irg/irg50/IRGN2302EddieLi.pdf) corrections.&ensp;The correct behaviour with respect to the IRGN2302 corrections is unclear since [the Chinese national body rejected them in IRGN2376](https://appsrv.cse.cuhk.edu.hk/~irg/irg/irg52/IRGN2376_UpdateGRef.pdf), and GB/T 13131 was never published (IRGN2302 references the theoretically homologous GB/T 7589).|
|`IRR 2 G*DM4 ! 8`|GB 7589 (supplementary simplified)&mdash;this is generated from the GB 13131 mappings, and may be minorly inaccurate in places.|
|`IRR 3 G*DM4 ! 8`|GB 13131 (supplementary traditional) with [IRGN2302](https://appsrv.cse.cuhk.edu.hk/~irg/irg/irg50/IRGN2302EddieLi.pdf) corrections.&ensp;The correct behaviour with respect to the IRGN2302 corrections is unclear for the reasons mentioned above.|
|`IRR ? G*DM4 ! 9`|Currently same as `IRR 1 G*DM4 ! 9` but may change in future.|
|`IRR 0 G*DM4 ! 9`|Almost GB 7590 (further supplementary simplified), based on the GB 13132 mappings without [IRGN2302](https://appsrv.cse.cuhk.edu.hk/~irg/irg/irg50/IRGN2302EddieLi.pdf) corrections&mdash;this is generated from the GB 13132 mappings, and may be minorly inaccurate in places.|
|`IRR 1 G*DM4 ! 9`|GB 13132 (further supplementary traditional), without [IRGN2302](https://appsrv.cse.cuhk.edu.hk/~irg/irg/irg50/IRGN2302EddieLi.pdf) corrections.&ensp;The correct behaviour in relation to the IRGN2302 corrections is unclear since [the Chinese national body rejected them in IRGN2376](https://appsrv.cse.cuhk.edu.hk/~irg/irg/irg52/IRGN2376_UpdateGRef.pdf), and GB/T 13132 was never published (IRGN2302 references the theoretically homologous GB/T 7590).|
...
|`IRR 3 G*DM4 ! 9`|GB 13132 (further supplementary traditional) with [IRGN2302](https://appsrv.cse.cuhk.edu.hk/~irg/irg/irg50/IRGN2302EddieLi.pdf) corrections.&ensp;The correct behaviour with respect to the IRGN2302 corrections is unclear for the reasons mentioned above.|
