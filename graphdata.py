...
gsets = {# ECMA-6:US, current ECMA-6:IRV, US-ASCII
         ...
         # Following the ISO-IR-111 reg and ECMA-113:1986 (not later, which would be 144), as 
         # opposed to the very different (mistaken but influential) definition in RFC 1345.
         ...
         # ELOT-928 ECMA-118 ISO-8859-7 Latin/Greek RHS
         "ir126": (96, 1, (0x00A0, 0x2018, 0x2019, 0x00A3, 0x20AC, 0x20AF, 0x00A6, 0x00A7, 
         ...
         "ir127": (96, 1, (0x00A0, None, None, None, 0x00A4, None, None, None, 
                         ...
                         None, None, None, None, None, None, None, None)),
         # ECMA-121 ISO-8859-8 Latin/Hebrew RHS
