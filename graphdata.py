...
gsets = {"006": (94, 1, tuple(range(0x21, 0x7F))),
         ...
         "042": multibyte.jisx0208_gzdm4_at,
         "058": multibyte.gb2312,
         "087": multibyte.jisx0208_gzdm4_b,
         ...
         "111": (96, 1, (0x00A0, 0x0452, 0x0453, 0x0451, 0x0454, 0x0455, 0x0456, 0x0457, 
         ...
         "139": (96, 1, (0x00A0, 0x0104, 0x02D8, 0x0141, 0x0024, 0x013D, 0x015A, 0x00A7, 
                         0x00A8, 0x0160, 0x015E, 0x0164, 0x0179, 0x00AD, 0x017D, 0x017B, 
                         0x00B0, 0x0105, 0x02DB, 0x0142, 0x00B4, 0x013E, 0x015B, 0x02C7, 
                         0x00B8, 0x0161, 0x015F, 0x0165, 0x017A, 0x02DD, 0x017E, 0x017C, 
                         0x0154, 0x00C1, 0x00C2, 0x0102, 0x00C4, 0x0139, 0x0106, 0x00C7, 
         ...
         "168": multibyte.jisx0208_irr_at_gzdm4_b,
...
g94nbytes = {tuple(b"@"): "042",
             tuple(b"A"): "058",
             tuple(b"B"): "168", # Or older pre-IRR "087"
             tuple(b"C"): "149",
             tuple(b"D"): "159",
             tuple(b"~"): "nil"}
