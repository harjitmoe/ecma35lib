...
gsets = {# ECMA-6:US, current ECMA-6:IRV, US-ASCII
         ...
         "ir042": multibyte.jisx0208_gzdm4_at,
         # GB 2312 (EUC-CN RHS)
         "ir058": multibyte.gb2312,
         # JIS C 6226:1983 / JIS X 0208:1983
         "ir087": multibyte.jisx0208_gzdm4_b,
         # ECMA-94:L1 ISO-8859-1 Latin-1 Western European RHS
         "ir100": (96, 1, tuple(range(0xA0, 0x100))),
         # ECMA-94:L2 ISO-8859-2 Latin-2 Central European RHS
         "ir101": (96, 1, (0x00A0, 0x0104, 0x02D8, 0x0141, 0x00A4, 0x013D, 0x015A, 0x00A7, 
         ...
         "ir109": (96, 1, (0x00A0, 0x0126, 0x02D8, 0x00A3, 0x00A4, None, 0x0124, 0x00A7, 
         ...
         "ir110": (96, 1, (0x00A0, 0x0104, 0x0138, 0x0156, 0x00A4, 0x0128, 0x013B, 0x00A7, 
         ...
         "ir111": (96, 1, (0x00A0, 0x0452, 0x0453, 0x0451, 0x0454, 0x0455, 0x0456, 0x0457, 
         ...
         "ir126": (96, 1, (0x00A0, 0x2018, 0x2019, 0x00A3, None, None, 0x00A6, 0x00A7, 
         ...
         "ir127": (96, 1, (0x00A0, None, None, None, 0x00A4, None, None, None, 
         ...
         "ir138": (96, 1, (0x00A0, None, 0x00A2, 0x00A3, 0x00A4, 0x00A5, 0x00A6, 0x00A7, 
         ...
         "ir139": (96, 1, (0x00A0, 0x0104, 0x02D8, 0x0141, 0x0024, 0x013D, 0x015A, 0x00A7, 
                         0x00A8, 0x0160, 0x015E, 0x0164, 0x0179, 0x00AD, 0x017D, 0x017B, 
                         0x00B0, 0x0105, 0x02DB, 0x0142, 0x00B4, 0x013E, 0x015B, 0x02C7, 
                         0x00B8, 0x0161, 0x015F, 0x0165, 0x017A, 0x02DD, 0x017E, 0x017C, 
                         0x0154, 0x00C1, 0x00C2, 0x0102, 0x00C4, 0x0139, 0x0106, 0x00C7, 
         ...
         "ir144": (96, 1, (0x00A0, 0x0401, 0x0402, 0x0403, 0x0404, 0x0405, 0x0406, 0x0407, 
                         0x0408, 0x0409, 0x040A, 0x040B, 0x040C, 0x00AD, 0x040E, 0x040F, 
                         0x0410, 0x0411, 0x0412, 0x0413, 0x0414, 0x0415, 0x0416, 0x0417, 
                         0x0418, 0x0419, 0x041A, 0x041B, 0x041C, 0x041D, 0x041E, 0x041F, 
                         0x0420, 0x0421, 0x0422, 0x0423, 0x0424, 0x0425, 0x0426, 0x0427, 
         ...
         "ir148": (96, 1, (0x00A0, 0x00A1, 0x00A2, 0x00A3, 0x00A4, 0x00A5, 0x00A6, 0x00A7, 
         ...
         "ir149": multibyte.wansung,
         # ECMA-144 ISO-8859-10 Latin-6 Nordic RHS
         "ir157": (96, 1, (0x00A0, 0x0104, 0x0112, 0x0122, 0x012A, 0x0128, 0x0136, 0x00A7, 
         ...
         "ir164": (96, 1, (None, None, None, None, None, None, None, None, 
                         None, None, None, None, None, None, None, None, 
                         None, None, None, None, None, None, None, None, 
                         None, None, None, None, None, None, None, None, 
                         None, None, None, None, None, None, None, None, 
         ...
         "ir166": (96, 1, (0x00A0, 0x0E01, 0x0E02, 0x0E03, 0x0E04, 0x0E05, 0x0E06, 0x0E07, 
         ...
         # JIS X 0208:1990 (thru 1997)
         "ir168": multibyte.jisx0208_irr_at_gzdm4_b,
         # JIS X 0208, Microsoft and WHATWG version
         "ir168ms932": multibyte.jisx0208_html5,
         # ISO-8859-13 Latin-7 Baltic Rim RHS
         "ir179": (96, 1, (0x00A0, 0x201D, 0x00A2, 0x00A3, 0x00A4, 0x201E, 0x00A6, 0x00A7, 
         ...
         "ir198": (96, 1, (0x00A0, None, 0x00A2, 0x00A3, 0x00A4, 0x00A5, 0x00A6, 0x00A7, 
                         0x00A8, 0x00A9, 0x00D7, 0x00AB, 0x00AC, 0x00AD, 0x00AE, 0x00AF, 
                         0x00B0, 0x00B1, 0x00B2, 0x00B3, 0x00B4, 0x00B5, 0x00B6, 0x00B7, 
                         0x00B8, 0x00B9, 0x00F7, 0x00BB, 0x00BC, 0x00BD, 0x00BE, None, 
                         None, None, None, None, None, None, None, None, 
         ...
         "ir199": (96, 1, (0x00A0, 0x1E02, 0x1E03, 0x00A3, 0x010A, 0x010B, 0x1E0A, 0x00A7, 
         ...
         "ir203": (96, 1, (0x00A0, 0x00A1, 0x00A2, 0x00A3, 0x20AC, 0x00A5, 0x0160, 0x00A7, 
         ...
         "ir204": (96, 1, (0x00A0, 0x00A1, 0x00A2, 0x00A3, 0x20AC, 0x00A5, 0x00A6, 0x00A7, 
                           ) + tuple(range(0xA8, 0x100))),
         # Euro update of ECMA-94:L4 ISO-8859-4 Latin-4 North European RHS
         "ir205": (96, 1, (0x00A0, 0x0104, 0x0138, 0x0156, 0x20AC, 0x0128, 0x013B, 0x00A7, 
                         0x00A8, 0x0160, 0x0112, 0x0122, 0x0166, 0x00AD, 0x017D, 0x00AF, 
                         0x00B0, 0x0105, 0x02DB, 0x0157, 0x00B4, 0x0129, 0x013C, 0x02C7, 
                         0x00B8, 0x0161, 0x0113, 0x0123, 0x0167, 0x014A, 0x017E, 0x014B, 
                         0x0100, 0x00C1, 0x00C2, 0x00C3, 0x00C4, 0x00C5, 0x00C6, 0x012E, 
         ...
         "ir206": (96, 1, (0x00A0, 0x201D, 0x00A2, 0x00A3, 0x20AC, 0x201E, 0x00A6, 0x00A7, 
                         0x00D8, 0x00A9, 0x0156, 0x00AB, 0x00AC, 0x00AD, 0x00AE, 0x00C6, 
                         0x00B0, 0x00B1, 0x00B2, 0x00B3, 0x201C, 0x00B5, 0x00B6, 0x00B7, 
                         0x00F8, 0x00B9, 0x0157, 0x00BB, 0x00BC, 0x00BD, 0x00BE, 0x00E6, 
                         0x0104, 0x012E, 0x0100, 0x0106, 0x00C4, 0x00C5, 0x0118, 0x0112, 
         ...
         # Registered as a 96-set for some reason but doesn't actually allocate the corners.
         "ir208": (96, 1, ((None,) * 64) + tuple(range(0x1680, 0x169D)) + (None, None, None)),
         # SR-14111 ISO-8859-16 Latin-10 South-Eastern European RHS
         "ir226": (96, 1, (0x00A0, 0x0104, 0x0105, 0x0141, 0x20AC, 0x201E, 0x0160, 0x00A7, 
         ...
         "ir227": (96, 1, (0x00A0, 0x2018, 0x2019, 0x00A3, 0x20AC, 0x20AF, 0x00A6, 0x00A7, 
         ...
         "ir234": (96, 1, (0x00A0, None, 0x00A2, 0x00A3, 0x00A4, 0x00A5, 0x00A6, 0x00A7, 
                         0x00A8, 0x00A9, 0x00D7, 0x00AB, 0x00AC, 0x00AD, 0x00AE, 0x00AF, 
                         0x00B0, 0x00B1, 0x00B2, 0x00B3, 0x00B4, 0x00B5, 0x00B6, 0x00B7, 
                         0x00B8, 0x00B9, 0x00F7, 0x00BB, 0x00BC, 0x00BD, 0x00BE, None, 
                         None, None, None, None, None, None, None, None, 
