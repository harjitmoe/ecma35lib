...
# 0xabad1dea's C0 graphics for Windows-1252 on the Famicom (U+3013 is a poor mapping but best available it seems):
graphdata.c0graphics["1252"] = (None, 0x1F7E5, 0x1F7E9, 0x2588, 0x3013, 0x1FB97, 0x2592, 0x2661, 0x2662, 0x2667, 0x2664, 0x263A, 0x2639, 0x1D15E, 0x266B, 0x266A, 0x2640, 0x2642, 0x23FB, 0x24B6, 0x24B7, 0x2191, 0x2193, 0x2190, 0x2192, 0x254B, 0x2503, 0x2501, 0x2595, 0x2594, 0x2581, 0x258F, None)
