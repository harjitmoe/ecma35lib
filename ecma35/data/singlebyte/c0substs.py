...
graphdata.c0graphics["998100"] = ( # "OT1" and charsets supplementing it
  ...
  (0x0131,), (0x0237,), (0x02CB,), (0x00B4,), (0x02C7,), (0x02D8,), (0x00AF,), (0x02DA,),
...
graphdata.c0graphics["996320"] = ( # "X2"
  ...
  (0x02D8,), (0x00AF,), (0x02D9,),        (0x00B8,), (0x02DB,), (0x04CF,), (0x2329,), (0x232A,),
...
graphdata.c0graphics["996123"] = ( # "T2" (FreeDOS code page 60643 is LaTeX "T2A")
  ...
  (0xFF61,), (0x0131,), (0x0237,),        (0xFB00,), (0xFB01,), (0xFB02,), (0xFB03,), (0xFB04,),
    (0x00AD,))
graphdata.c0graphics["996130"] = ( # "T3"
  (0x02CB,), (0x00B4,), (0x02C6,), (0x02DC,), (0x00A8,), (0x02DD,), (0x02DA,), (0x02C7,),
  (0x02D8,), (0x00AF,), (0x02D9,), (0x00B8,), (0x02DB,), (0x02F5,), (0x02CB,), (0x00B4,),
  (0x0311,), (0x032A,), (0x02FD,), (0x033B,), (0x02D2,), (0x02D3,), (0x032B,), (0x033C,),
  (0x02DF,), (0x0131,), (0x0237,), (0x02D6,), (0x02D4,), (0x02D5,), (0xAB6A,), (0xAB6B,),
    (0x02CC,))
...
graphdata.c0graphics["301252"] = ( # "TeX Base1"
  ...
  (0x2264,), (0x2265,), (0x2202,), (0x2211,), (0x220F,), (0x03C0,), (0x02CB,), (0x0027,),
    (0x2302,))
