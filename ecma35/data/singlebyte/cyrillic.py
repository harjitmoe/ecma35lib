...
# ETS 300 706 G0 set for Russian and Bulgarian (modified KOI-7; better for Bulgarian than KOI-7,
#   while the unmodified KOI-7 is better for Russian than the ETS 300 706 modification)
graphdata.gsets["etscyrillic/bulgarian"] = (94, 1, (
               (0x21,),   (0x22,),   (0x23,),   (0x24,),   (0x25,),   (0x044B,), (0x27,),
    (0x28,),   (0x29,),   (0x2A,),   (0x2B,),   (0x2C,),   (0x2D,),   (0x2E,),   (0x2F,),
    (0x30,),   (0x31,),   (0x32,),   (0x33,),   (0x34,),   (0x35,),   (0x36,),   (0x37,),
    (0x38,),   (0x39,),   (0x3A,),   (0x3B,),   (0x3C,),   (0x3D,),   (0x3E,),   (0x3F,),
    (0x042E,), (0x0410,), (0x0411,), (0x0426,), (0x0414,), (0x0415,), (0x0424,), (0x0413,),
    ...
    (0x0445,), (0x0438,), (0x0439,), (0x043A,), (0x043B,), (0x043C,), (0x043D,), (0x043E,),
    (0x043F,), (0x044F,), (0x0440,), (0x0441,), (0x0442,), (0x0443,), (0x0436,), (0x0432,),
    (0x044C,), (0x044A,), (0x0437,), (0x0448,), (0x044D,), (0x0449,), (0x0447,)))

# ETS 300 706 G0 set for Ukrainian (modified KOI-7)
graphdata.gsets["etscyrillic/ukrainian"] = (94, 1, (
               (0x21,),   (0x22,),   (0x23,),   (0x24,),   (0x25,),   (0x0457,), (0x27,),
    (0x28,),   (0x29,),   (0x2A,),   (0x2B,),   (0x2C,),   (0x2D,),   (0x2E,),   (0x2F,),
    (0x30,),   (0x31,),   (0x32,),   (0x33,),   (0x34,),   (0x35,),   (0x36,),   (0x37,),
    (0x38,),   (0x39,),   (0x3A,),   (0x3B,),   (0x3C,),   (0x3D,),   (0x3E,),   (0x3F,),
    (0x042E,), (0x0410,), (0x0411,), (0x0426,), (0x0414,), (0x0415,), (0x0424,), (0x0413,),
    ...
    (0x0445,), (0x0438,), (0x0439,), (0x043A,), (0x043B,), (0x043C,), (0x043D,), (0x043E,),
    (0x043F,), (0x044F,), (0x0440,), (0x0441,), (0x0442,), (0x0443,), (0x0436,), (0x0432,),
    (0x044C,), (0x0456,), (0x0437,), (0x0448,), (0x0454,), (0x0449,), (0x0447,)))
...
graphdata.gsets["etscyrillic/serbian"] = (94, 1, (
    ...
    (0x0459,), (0x045A,), (0x0437,), (0x045B,), (0x0436,), (0x0452,), (0x0448,)))
...
# LaTeX "T2A" charset (matches Windows-1251 for Bulgarian/Russian; FreeDOS uses it for
#   "Northeastern Iranian languages")
graphdata.rhses["60643"] = graphdata.rhses["996121"] = (
...
# LaTeX "T2B" charset (matches Windows-1251 for Bulgarian/Russian; FreeDOS uses it for
#   Aleutian languages)
graphdata.rhses["61667"] = graphdata.rhses["996122"] = (
  (0x04FA,), (0x0492,), (0x04F6,), (0x0494,), (0x04BA,), (0x0496,), (0xA7D8,), (0x04E0,),
  (0x0409,), (0x049A,), (0x04C5,), (0x04C3,), (0x0512,), (0x04A2,), (0x04A4,), (0x04C7,),
  (0x04E8,), (0x023B,), (0x040E,), (0x04AE,), (0x04FE,), (0x04B2,), (0x04FC,), (0x04CB,),
  (0x04B6,), (0x040A,), (0x04D8,), (0x0510,), (0x0401,), (0x2116,), (0x00A4,), (0x00A7,),
  (0x04FB,), (0x0493,), (0x04F7,), (0x0495,), (0x04BB,), (0x0497,), (0xA7D9,), (0x04E1,),
  (0x0459,), (0x049B,), (0x04C6,), (0x04C4,), (0x0513,), (0x04A3,), (0x04A5,), (0x04C8,),
  (0x04E9,), (0x023C,), (0x045E,), (0x04AF,), (0x04FF,), (0x04B3,), (0x04FD,), (0x04CC,),
...
# LaTeX "T2C" charset (matches Windows-1251 for Bulgarian/Russian; FreeDOS uses it for
#   Tungusic languages)
graphdata.rhses["62691"] = ( # "T2C" variant with Church Slavonic letters
  (0x04A6,), (0x04B4,), (0x04AC,), (0x0494,), (0x04BA,), (0x0420, 0x0329), (0x048E,), (0x04E0,),
  (0x04CD,), (0x049A,), (0x04C5,), (0x049E,), (0x0512,), (0x04A2,), (0x041C, 0x0321), (0x04C7,),
  (0x04E8,), (0x04BC,), (0x04BE,), (0x0462,), (0x0474,), (0x04B2,),        (0x040F,), (0x04A8,),
  (0x04B6,), (0x0528,), (0x04D8,), (0x046A,), (0x0401,), (0x2116,),        (0x00A4,), (0x00A7,),
  (0x04A7,), (0x04B5,), (0x04AD,), (0x0495,), (0x04BB,), (0x0440, 0x0329), (0x048F,), (0x04E1,),
  (0x04CE,), (0x049B,), (0x04C6,), (0x049F,), (0x0513,), (0x04A3,), (0x043C, 0x0321), (0x04C8,),
  (0x04E9,), (0x04BD,), (0x04BF,), (0x0463,), (0x0475,), (0x04B3,),        (0x045F,), (0x04A9,),
  (0x04B7,), (0x0529,), (0x04D9,), (0x046B,), (0x0451,), (0x201E,),        (0x00AB,), (0x00BB,),
  (0x0410,), (0x0411,), (0x0412,), (0x0413,), (0x0414,), (0x0415,),        (0x0416,), (0x0417,),
  (0x0418,), (0x0419,), (0x041A,), (0x041B,), (0x041C,), (0x041D,),        (0x041E,), (0x041F,),
  (0x0420,), (0x0421,), (0x0422,), (0x0423,), (0x0424,), (0x0425,),        (0x0426,), (0x0427,),
  (0x0428,), (0x0429,), (0x042A,), (0x042B,), (0x042C,), (0x042D,),        (0x042E,), (0x042F,),
  ...
  (0x0440,), (0x0441,), (0x0442,), (0x0443,), (0x0444,), (0x0445,),        (0x0446,), (0x0447,),
  (0x0448,), (0x0449,), (0x044A,), (0x044B,), (0x044C,), (0x044D,),        (0x044E,), (0x044F,))
graphdata.rhses["996123"] = ( # "T2C" variant with Saami letters
  (0x04A6,), (0x04B4,), (0x04AC,), (0x0494,), (0x04BA,), (0x0420, 0x0329), (0x048E,), (0x04E0,),
  (0x04CD,), (0x049A,), (0x04C5,), (0x049E,), (0x0512,), (0x04A2,), (0x041C, 0x0321), (0x04C7,),
...
# LaTeX "X2" charset
graphdata.gsets["tex-extended-cyrillic-gl"] = (94, 1, (
  ...
  (0x0420, 0x0329), (0x051A,), (0x04AC,), (0x0405,), (0x04B4,), (0x040F,), (0x04B8,), (0x051C,),
  ...
  (0x0440, 0x0329), (0x051B,), (0x04AD,), (0x0455,), (0x04B5,), (0x045F,), (0x04B9,), (0x051D,),
  (0x0463,), (0x046B,), (0x0475,), (0x007B,), (0x007C,), (0x007D,), (0x007E,)))
graphdata.rhses["996320"] = (
  ...
  (0x0440,), (0x0441,), (0x0442,), (0x0443,), (0x0444,), (0x0445,), (0x0446,), (0x0447,),
  (0x0448,), (0x0449,), (0x044A,), (0x044B,), (0x044C,), (0x044D,), (0x044E,), (0x044F,))
graphdata.defgsets["996320"] = ("tex-extended-cyrillic-gl", "nil", "nil", "nil")
...
_ot2 = (
  ...
  (0xA67E,), (0x0410,), (0x0411,), (0x0426,), (0x0414,), (0x0415,), (0x0424,), (0x0413,),
  (0x0425,), (0x0418,), (0x0408,), (0x041A,), (0x041B,), (0x041C,), (0x041D,), (0x041E,),
...
graphdata.gsets["tex-7bit-cyrillic-gl"] = (94, 1, _ot2[33:127])
graphdata.c0graphics["996720"] = (*_ot2[:32], _ot2[127])
graphdata.defgsets["996720"] = ("tex-7bit-cyrillic-gl", "nil", "nil", "nil")
graphdata.rhses["996720"] = (None,) * 128
graphdata.rhses["996721"] = tuple(i if not i or len(i) > 1 or i[0] > 0x7F else (i[0] + 0xFEE0,)
                                  for i in _ot2)

# Cyrillic charset as used by the Hershey "cyrilc_1" font
graphdata.gsets["hershey-cyrillic-alternate"] = (94, 1, (
            (0x0021,), (0x037E,), (0x0023,), (0x0024,), (0x0025,), (0x0026,), (0x2019,),
 (0x0028,), (0x0029,), (0x002A,), (0x002B,), (0x002C,), (0x002D,), (0x002E,), (0x002F,),
 (0x0030,), (0x0031,), (0x0032,), (0x0033,), (0x0034,), (0x0035,), (0x0036,), (0x0037,),
 (0x0038,), (0x0039,), (0x003A,), (0x003B,), (0x003C,), (0x003D,), (0x003E,), (0x003F,),
 (0x0040,), (0x0410,), (0x0411,), (0x0412,), (0x0413,), (0x0414,), (0x0415,), (0x0416,),
 (0x0417,), (0x0418,), (0x0419,), (0x041A,), (0x041B,), (0x041C,), (0x041D,), (0x041E,),
 (0x041F,), (0x0420,), (0x0421,), (0x0422,), (0x0423,), (0x0424,), (0x0425,), (0x0426,),
 (0x0427,), (0x0428,), (0x0429,), (0x005B,), (0x005C,), (0x005D,), (0x2191,), (0x005F,),
 (0x2018,), (0x0430,), (0x0431,), (0x0432,), (0x0433,), (0x0434,), (0x0435,), (0x0436,),
 (0x0437,), (0x0438,), (0x0439,), (0x043A,), (0x043B,), (0x043C,), (0x043D,), (0x043E,),
 (0x043F,), (0x0440,), (0x0441,), (0x0442,), (0x0443,), (0x0444,), (0x0445,), (0x0446,),
 (0x0447,), (0x0448,), (0x0449,), (0x007B,), (0x007C,), (0x007D,), (0x007E,)))

# Cyrillic charset as used by the Hershey "cyrillic" font
graphdata.gsets["hershey-cyrillic"] = (94, 1, (
            (0x0021,), (0x0022,), (0x0023,), (0x042B,), (0x0446,), (0x044B,), (0x0027,),
 (0x0028,), (0x0029,), (0x002A,), (0x002B,), (0x002C,), (0x002D,), (0x002E,), (0x002F,),
 (0x0030,), (0x0031,), (0x0032,), (0x0033,), (0x0034,), (0x0035,), (0x0036,), (0x0037,),
 (0x0038,), (0x0039,), (0x003A,), (0x003B,), (0x003C,), (0x003D,), (0x003E,), (0x003F,),
 (0x0040,), (0x0410,), (0x0411,), (0x042D,), (0x0414,), (0x0419,), (0x0424,), (0x0413,),
 (0x0416,), (0x0418,), (0x0427,), (0x041A,), (0x041B,), (0x041C,), (0x041D,), (0x041E,),
 (0x041F,), (0x0428,), (0x0420,), (0x0421,), (0x0422,), (0x042E,), (0x0412,), (0x0429,),
 (0x0425,), (0x0423,), (0x0417,), (0x0415,), (0x005C,), (0x042A,), (0x042F,), (0x042C,),
 (0x0426,), (0x0430,), (0x0431,), (0x044D,), (0x0434,), (0x0439,), (0x0444,), (0x0433,),
 (0x0436,), (0x0438,), (0x0447,), (0x043A,), (0x043B,), (0x043C,), (0x043D,), (0x043E,),
 (0x043F,), (0x0448,), (0x0440,), (0x0441,), (0x0442,), (0x044E,), (0x0432,), (0x0449,),
 (0x0445,), (0x0443,), (0x0437,), (0x0435,), (0x044A,), (0x044F,), (0x044C,)))
