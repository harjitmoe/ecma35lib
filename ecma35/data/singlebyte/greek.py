...
# By HarJIT in 2019, 2020, 2022, 2024, 2025, 2026.
...
# Variant Unicode mapping for ISO-8859-7. X11 calls it "suneu-greek".
graphdata.gsets["ir126/euro/alt"] = (96, 1, (
         (0x00A0,), (0x02BD,), (0x2019,), (0x00A3,), (0x20AC,), None,      (0x00A6,), (0x00A7,), 
         (0x00A8,), (0x00A9,), None,      (0x00AB,), (0x00AC,), (0x00AD,), None,      (0x2014,), 
         (0x00B0,), (0x00B1,), (0x00B2,), (0x00B3,), (0x0384,), (0x0385,), (0x0386,), (0x00B7,), 
         (0x0388,), (0x0389,), (0x038A,), (0x00BB,), (0x038C,), (0x00BD,), (0x038E,), (0x038F,), 
         (0x0390,), (0x0391,), (0x0392,), (0x0393,), (0x0394,), (0x0395,), (0x0396,), (0x0397,), 
         (0x0398,), (0x0399,), (0x039A,), (0x039B,), (0x039C,), (0x039D,), (0x039E,), (0x039F,), 
         ...
         (0x03C0,), (0x03C1,), (0x03C2,), (0x03C3,), (0x03C4,), (0x03C5,), (0x03C6,), (0x03C7,), 
         (0x03C8,), (0x03C9,), (0x03CA,), (0x03CB,), (0x03CC,), (0x03CD,), (0x03CE,), None))
graphdata.gsets["ir126/euro/alt/94"] = (94, 1, graphdata.gsets["ir126/euro/alt"][2][1:-1])
...
graphdata.gsets["ir181"] = (96, 1, (
    ...
    (0x2248,), (0x2261,), (0x2265,), (0x226B,), (0x2122,), (0x2104,), (0x23E4,),  (0x2393,), 
...
# SPIonic charset for Biblical Greek (modified Thesaurus Linguae Graecae)
graphdata.gsets["spionic"] = (94, 1, (
               (0x1FCE,), (0x00A8,), (0x1FDE,), (0x1FDD,), (0x0385,), (0x1FFD,), (0x1FBD,),
    (0x1FFE,), (0x1FBD,), (0x2013,), (0x00A8,), (0x002C,), (0x2014,), (0x002E,), (0x1FFD,),
    (0x1FBD,), (0x1FCE,), (0x1FCD,), (0x1FDE,), (0x1FDD,), (0x0385,), (0x1FED,), (0x00A0,),
    (0x00AF,), (0x1FFE,), (0x0387,), (0x037E,), (0x00AF,), (0x02DC,), (0x00AF,), (0x0323,),
    (0x1FCD,), (0x0391,), (0x0392,), (0x039E,), (0x0394,), (0x0395,), (0x03A6,), (0x0393,),
    (0x0397,), (0x0399,), (0x03D8,), (0x039A,), (0x039B,), (0x039C,), (0x039D,), (0x039F,),
    (0x03A0,), (0x0398,), (0x03A1,), (0x03A3,), (0x03A4,), (0x03A5,), (0x03DC,), (0x03A9,),
    (0x03A7,), (0x03A8,), (0x0396,), (0x1FDF,), (0x1FEF,), (0x1FCF,), (0x1FED,), (0x1FEF,),
    (0x03E1,), (0x03B1,), (0x03B2,), (0x03BE,), (0x03B4,), (0x03B5,), (0x03C6,), (0x03B3,),
    (0x03B7,), (0x03B9,), (0x03C2,), (0x03BA,), (0x03BB,), (0x03BC,), (0x03BD,), (0x03BF,),
    (0x03C0,), (0x03B8,), (0x03C1,), (0x03C3,), (0x03C4,), (0x03C5,), (0x03DB,), (0x03C9,),
    (0x03C7,), (0x03C8,), (0x03B6,), (0x1FDF,), (0x037A,), (0x1FCF,), (0x02DC,)))
...
# Greek charset as used by the Hershey "greek" and "timesg" fonts
graphdata.gsets["hershey-greek"] = (94, 1, (
            (0x0021,), (0x0022,), (0x0023,), (0x0024,), (0x0025,), (0x0026,), (0x0027,),
 (0x0028,), (0x0029,), (0x002A,), (0x002B,), (0x002C,), (0x002D,), (0x002E,), (0x002F,),
 (0x0030,), (0x0031,), (0x0032,), (0x0033,), (0x0034,), (0x0035,), (0x0036,), (0x0037,),
 (0x0038,), (0x0039,), (0x003A,), (0x003B,), (0x003C,), (0x003D,), (0x003E,), (0x003F,),
 (0x0040,), (0x0391,), (0x0392,), (0x03A7,), (0x0394,), (0x0395,), (0x03A6,), (0x0393,),
 (0x0397,), (0x0399,), (0x0387,), (0x039A,), (0x039B,), (0x039C,), (0x039D,), (0x039F,),
 (0x03A0,), (0x0398,), (0x03A1,), (0x03A3,), (0x03A4,), (0x03A5,), (0x00B0,), (0x03A9,),
 (0x039E,), (0x03A8,), (0x0396,), (0x005B,), (0x005C,), (0x005D,), (0x005E,), (0x005F,),
 (0x0060,), (0x03B1,), (0x03B2,), (0x03C7,), (0x03B4,), (0x03B5,), (0x03C6,), (0x03B3,),
 (0x03B7,), (0x03B9,), (0x00D7,), (0x03BA,), (0x03BB,), (0x03BC,), (0x03BD,), (0x03BF,),
 (0x03C0,), (0x03D1,), (0x03C1,), (0x03C3,), (0x03C4,), (0x03C5,), (0x00F7,), (0x03C9,),
 (0x03BE,), (0x03C8,), (0x03B6,), (0x007B,), (0x007C,), (0x007D,), (0x007E,)))
graphdata.gsets["hershey-greek/smartquotes"] = (94, 1, (
            (0x0021,), (0x0022,), (0x0023,), (0x0024,), (0x0025,), (0x0026,), (0x2019,),
 (0x0028,), (0x0029,), (0x002A,), (0x002B,), (0x002C,), (0x002D,), (0x002E,), (0x002F,),
 (0x0030,), (0x0031,), (0x0032,), (0x0033,), (0x0034,), (0x0035,), (0x0036,), (0x0037,),
 (0x0038,), (0x0039,), (0x003A,), (0x003B,), (0x003C,), (0x003D,), (0x003E,), (0x003F,),
 (0x0040,), (0x0391,), (0x0392,), (0x03A7,), (0x0394,), (0x0395,), (0x03A6,), (0x0393,),
 ...
 (0x03A0,), (0x0398,), (0x03A1,), (0x03A3,), (0x03A4,), (0x03A5,), (0x00B0,), (0x03A9,),
 (0x039E,), (0x03A8,), (0x0396,), (0x005B,), (0x005C,), (0x005D,), (0x005E,), (0x005F,),
 (0x2018,), (0x03B1,), (0x03B2,), (0x03C7,), (0x03B4,), (0x03B5,), (0x03C6,), (0x03B3,),
 (0x03B7,), (0x03B9,), (0x00D7,), (0x03BA,), (0x03BB,), (0x03BC,), (0x03BD,), (0x03BF,),
 (0x03C0,), (0x03D1,), (0x03C1,), (0x03C3,), (0x03C4,), (0x03C5,), (0x00F7,), (0x03C9,),
 (0x03BE,), (0x03C8,), (0x03B6,), (0x007B,), (0x007C,), (0x007D,), (0x007E,)))

# Greek charset as used by the Hershey "greekc" and "greeks" fonts
graphdata.gsets["hershey-greek-alternate"] = (94, 1, (
            (0x0021,), (0x0022,), (0x0023,), (0x0024,), (0x0025,), (0x0026,), (0x2019,),
 (0x0028,), (0x0029,), (0x002A,), (0x002B,), (0x002C,), (0x002D,), (0x002E,), (0x002F,),
 (0x0030,), (0x0031,), (0x0032,), (0x0033,), (0x0034,), (0x0035,), (0x0036,), (0x0037,),
 (0x0038,), (0x0039,), (0x003A,), (0x003B,), (0x003C,), (0x003D,), (0x003E,), (0x003F,),
 ...
 (0x0398,), (0x0399,), (0x039A,), (0x039B,), (0x039C,), (0x039D,), (0x039E,), (0x039F,),
 (0x03A0,), (0x03A1,), (0x03A3,), (0x03A4,), (0x03A5,), (0x03A6,), (0x03A7,), (0x03A8,),
 (0x03A9,), None,      None,      (0x005B,), (0x005C,), (0x005D,), (0x2191,), (0x005F,),
 (0x2018,), (0x03B1,), (0x03B2,), (0x03B3,), (0x03B4,), (0x03B5,), (0x03B6,), (0x03B7,),
 (0x03D1,), (0x03B9,), (0x03BA,), (0x03BB,), (0x03BC,), (0x03BD,), (0x03BE,), (0x03BF,),
 (0x03C0,), (0x03C1,), (0x03C3,), (0x03C4,), (0x03C5,), (0x03C6,), (0x03C7,), (0x03C8,),
 (0x03C9,), None,      None,      (0x007B,), (0x007C,), (0x007D,), (0x007E,)))
graphdata.gsets["hershey-greek-alternate/disunified-semicolon"] = (94, 1, (
            (0x0021,), (0x037E,), (0x0032,), (0x0024,), (0x0025,), (0x0026,), (0x2019,),
 (0x0028,), (0x0029,), (0x002A,), (0x002B,), (0x002C,), (0x002D,), (0x002E,), (0x002F,),
 (0x0030,), (0x0031,), (0x0032,), (0x0033,), (0x0034,), (0x0035,), (0x0036,), (0x0037,),
 (0x0038,), (0x0039,), (0x003A,), (0x003B,), (0x003C,), (0x003D,), (0x003E,), (0x003F,),
 (0x0040,), (0x0391,), (0x0392,), (0x0393,), (0x0394,), (0x0395,), (0x0396,), (0x0397,),
...
# Charset used on the NEC Advanced Personal Computer
graphdata.rhses["992002"] = (
    (0x2581,), (0x2582,), (0x2583,), (0x2584,), (0x2585,), (0x2586,), (0x2587,), (0x2588,),
    (0x258F,), (0x258E,), (0x258D,), (0x258C,), (0x258B,), (0x258A,), (0x2589,), (0x254B,),
    (0x253B,), (0x2533,), (0x252B,), (0x2523,), (0x2594,), (0x2501,), (0x2503,), (0x2595,),
    (0x250F,), (0x2513,), (0x2517,), (0x251B,), (0x256D,), (0x256E,), (0x2570,), (0x256F,),
    (0x00A0,), (0x2265,), (0x2219,), (0x2007, 0x20F0), (0x2264,), (0x00B4,), (0x02D9,), (0x2191,),
    (0x00BD,), (0x2193,), (0x2190,), (0x2192,), (0x1F7A2,), (0x27EE,), (0x27EF,), (0x00BC,),
    (0x221E,), (0x00B3,), (0x03C4,), (0x2074,), (0x2075,), (0x2076,), (0x03F5,), (0x03C1,),
    (0x03C3,), (0x03C8,), (0x03A9,), (0x0393,), (0x2070,), (0x03BF,), (0x03BA,), (0x03A3,),
    (0x03B1,), (0x03BD,), (0x0394,), (0x03B2,), (0x03BE,), (0x03B7,), (0x03B8,), (0x00B9,),
    (0x00B1,), (0x03C5,), (0x03C0,), (0x039B,), (0x00B2,), (0x2A01,), (0x203E,), (0x2011,),
    (0x00A2,), (0x03C9,), (0x2248,), (0x03B3,), (0x2077,), (0x2078,), (0x2079,), (0x03B9,),
    (0x03D5,), (0x2260,), (0x03C7,), (0x00B0,), (0x29B0,), (0x03B6,), (0x03BB,), (0x03BC,),
    (0x2550,), (0x255E,), (0x256A,), (0x2561,), (0x25E2,), (0x25E3,), (0x25E5,), (0x25E4,),
    (0x2660,), (0x2665,), (0x2666,), (0x2663,), (0x25CF,), (0x25CB,), (0x2571,), (0x2572,),
    (0x2573,), (0x2508,), (0x250A,), (0x2537,), (0x252F,), (0x2528,), (0x2520,), (0x253C,),
    (0x2320,), (0x2321,), (0x23A1,), (0x23A3,), (0x23A4,), (0x23A6,), (0x23B2,), (0x23B3,))
