...
# OpenStep extensions to the "PostScript Standard" encoding
graphdata.rhses["301276"] = (
  ...
  (0x00B9,), (0x0060,), (0x00B4,), (0x02C6,), (0x02DC,), (0x00AF,), (0x02D8,), (0x02D9,),
  ...
  (0x0142,), (0x00F8,), (0x0153,), (0x00DF,), (0x00FE,), (0x00FF,), None,      None)
graphdata.defgsets["301276"] = ("ir006/smartquotes", "adobe-standard", "nil", "nil")

# ETS 300 706 modification of T.51 for use with the 7-bit Greek set
graphdata.gsets["etsgreek-g2"] = (94, 1, (
               (0x0061,), (0x0062,), (0x00A3,), (0x0065,), (0x0068,), (0x0069,), (0x00A7,),
    (0x00A6,), (0x2018,), (0x201C,), (0x006B,), (0x2190,), (0x2191,), (0x2192,), (0x2193,),
    ...
    (0x0073,), (0x0075,), (0x0076,), (0x0077,), (0x0079,), (0x007A,), (0x0388,)))

# ETS 300 706 modification of T.51 for use with the 7-bit Cyrillic set
graphdata.gsets["etscyrillic-g2"] = (96, 1, (
    (0x00A0,), (0x00A1,), (0x00A2,), (0x00A3,), (0x0024,), (0x00A5,), None,      (0x00A7,),
    None,      (0x2018,), (0x201C,), (0x00AB,), (0x2190,), (0x2191,), (0x2192,), (0x2193,),
    (0x00B0,), (0x00B1,), (0x00B2,), (0x00B3,), (0x00D7,), (0x00B5,), (0x00B6,), (0x00B7,),
    (0x00F7,), (0x2019,), (0x201D,), (0x00BB,), (0x00BC,), (0x00BD,), (0x00BE,), (0x00BF,),
    (0x00A0,), (-0x300,), (-0x301,), (-0x302,), (-0x303,), (-0x304,), (-0x306,), (-0x307,),
    (-0x308,), (-0x323,), (-0x30A,), (-0x327,), (-0x332,), (-0x30B,), (-0x328,), (-0x30C,),
    (0x2015,), (0x00B9,), (0x00AE,), (0x00A9,), (0x2122,), (0x266A,), (0x20A0,), (0x2030,),
    (0x221D,), (0x0141,), (0x0142,), (0x00DF,), (0x215B,), (0x215C,), (0x215D,), (0x215E,),
    (0x0044,), (0x0045,), (0x0046,), (0x0047,), (0x0049,), (0x004A,), (0x004B,), (0x004C,),
    (0x004E,), (0x0051,), (0x0052,), (0x0405,), (0x0055,), (0x0056,), (0x0057,), (0x005A,),
    (0x0064,), (0x0065,), (0x0066,), (0x0067,), (0x0069,), (0x006A,), (0x006B,), (0x006C,),
    (0x006E,), (0x0071,), (0x0072,), (0x0455,), (0x0075,), (0x0076,), (0x0077,), (0x007A,)))
