...
graphdata.gsets["ir219/marc"] = (94, 1, tuple((i,) if i else None for i in (
...
# ETS 300 706 7-bit Hebrew
graphdata.gsets["hebrew7/ets"] = (94, 1, (
    ...
    (0x58,),   (0x59,),   (0x5A,),   (0x2190,), (0xBD,),   (0x2192,), (0x2191,), (0x2317,),
    (0x05D0,), (0x05D1,), (0x05D2,), (0x05D3,), (0x05D4,), (0x05D5,), (0x05D6,), (0x05D7,),
    (0x05D8,), (0x05D9,), (0x05DA,), (0x05DB,), (0x05DC,), (0x05DD,), (0x05DE,), (0x05DF,),
    (0x05E0,), (0x05E1,), (0x05E2,), (0x05E3,), (0x05E4,), (0x05E5,), (0x05E6,), (0x05E7,),
    (0x05E8,), (0x05E9,), (0x05EA,), (0x20AA,), (0x05F0,), (0xBE,),   (0xF7,)))
...
# ETS 300 706 Arabic G0 charset
graphdata.gsets["etsarabic-g0"] = (94, 1, (
               (0x0021,), (0x0022,), (0x00A3,), (0x0024,), (0x0025,), (0xFE73,), (0xFEF2,),
    (0x0028,), (0x0029,), (0x002A,), (0x002B,), (0x002C,), (0x002D,), (0x002E,), (0x002F,),
    (0x0030,), (0x0031,), (0x0032,), (0x0033,), (0x0034,), (0x0035,), (0x0036,), (0x0037,),
    (0x0038,), (0x0039,), (0x003A,), (0x061B,), (0x003C,), (0x003D,), (0x003E,), (0x061F,),
    (0xFE94,), (0xFE80,), (0xFE92,), (0xFE8F,), (0xFE98,), (0xFE95,), (0xFE8E,), (0xFE8D,),
    (0xFE91,), (0x0629,), (0xFE97,), (0xFE9B,), (0xFE9F,), (0xFEA3,), (0xFEA7,), (0xFEA9,),
    (0xFEAB,), (0xFEAD,), (0xFEAF,), (0xFEB3,), (0xFEB7,), (0xFEBB,), (0xFEBF,), (0xFEC3,),
    (0xFEC7,), (0xFECB,), (0xFECF,), (0xFE9C,), (0xFEA0,), (0xFEA4,), (0xFEA8,), (0x2317,),
    (0x0640,), (0xFED3,), (0xFED7,), (0xFEDB,), (0xFEDF,), (0xFEE3,), (0xFEE7,), (0xFEEB,),
    (0xFEED,), (0xFEF0,), (0xFEF3,), (0xFE99,), (0xFE9D,), (0xFEA1,), (0xFEA5,), (0xFEF4,),
    (0xFEEF,), (0xFECC,), (0xFED0,), (0xFED4,), (0xFED1,), (0xFED8,), (0xFED5,), (0xFED9,),
    (0xFEE0,), (0xFEDD,), (0xFEE4,), (0xFEE1,), (0xFEE8,), (0xFEE5,), (0xFEFB,)))

# ETS 300 706 Arabic G2 charset
graphdata.gsets["etsarabic-g2"] = (94, 1, (
               (0xFEC9,), (0xFE81,), (0xFE83,), (0xFE85,), (0xFE87,), (0xFE8B,), (0x0626,),
    (0xFB7C,), (0xFB7D,), (0xFB7A,), (0xFB58,), (0xFB59,), (0xFB56,), (0xFB8A,), (0xFB94,),
    (0x0660,), (0x0661,), (0x0662,), (0x0663,), (0x0664,), (0x0665,), (0x0666,), (0x0667,),
    (0x0668,), (0x0669,), (0xFECE,), (0xFECD,), (0xFEFC,), (0xFEEC,), (0xFEEA,), (0xFEE9,),
    (0x00E0,), (0x0041,), (0x0042,), (0x0043,), (0x0044,), (0x0045,), (0x0046,), (0x0047,),
    (0x0048,), (0x0049,), (0x004A,), (0x004B,), (0x004C,), (0x004D,), (0x004E,), (0x004F,),
    (0x0050,), (0x0051,), (0x0052,), (0x0053,), (0x0054,), (0x0055,), (0x0056,), (0x0057,),
    (0x0058,), (0x0059,), (0x005A,), (0x00EB,), (0x00EA,), (0x00F9,), (0x00EE,), (0xFECA,),
    (0x00E9,), (0x0061,), (0x0062,), (0x0063,), (0x0064,), (0x0065,), (0x0066,), (0x0067,),
    (0x0068,), (0x0069,), (0x006A,), (0x006B,), (0x006C,), (0x006D,), (0x006E,), (0x006F,),
    (0x0070,), (0x0071,), (0x0072,), (0x0073,), (0x0074,), (0x0075,), (0x0076,), (0x0077,),
    (0x0078,), (0x0079,), (0x007A,), (0x00E2,), (0x00F4,), (0x00FB,), (0x00E7,)))
...
# SPTiberian charset for Biblical Hebrew (modified Michigan-Claremont)
graphdata.gsets["sptiberian"] = (94, 1, (
               (0x05C0,), (0x05B5,), (0x05E9,), (0x05C1,), (0x05BC,), (0x05C2,), (0x05B5,),
    (0x05E2,), (0x05D0,), (0x2024,), (0x05D8,), (0x05BC,), (0x05BE,), (0x05C3,), (0x05B3,),
    (0x05AB,), (0x05C7,), (0x05AB,), (0x0591,), (0x0591,), None,      None,      (0x05B0,),
    None,      None,      (0x05B0,), (0x05B0,), None,      (0x05BC,), None,      (0x05B3,),
    (0x05BC,), (0x05B7,), None,      (0x05E5,), None,      (0x05B6,), (0x05B8,), (0x05AF,),
    (0x05AF,), (0x05B4,), (0x05B2,), (0x05DA,), None,      (0x05DD,), (0x05DF,), (0x05C2,),
    (0x05E3,), (0x0323,), (0x0325,), (0x05C4,), (0x0325,), (0x05BB,), (0x05B1,), (0x0323,),
    (0x030A,), (0x030A,), (0x05C4,), (0x005B,), (0x05BD,), (0x005D,), (0x05BC,), (0x2013,),
    (0x05F3,), (0x05B7,), (0x05D1,), (0x05E6,), (0x05D3,), (0x05B6,), (0x05B8,), (0x05D2,),
    (0x05D4,), (0x05B4,), (0x05B2,), (0x05DB,), (0x05DC,), (0x05DE,), (0x05E0,), (0x05C2,),
    (0x05E4,), (0x05E7,), (0x05E8,), (0x05E1,), (0x05EA,), (0x05BB,), (0x05B1,), (0x05D5,),
    (0x05D7,), (0x05D9,), (0x05D6,), (0x05BF,), (0x05BD,), (0x05BF,), (0x05F4,)))

# SPEdessa charset for Classical Syriac Aramaic (modified Michigan-Claremont)
graphdata.gsets["spedessa"] = (94, 1, (
                      (0x0704,),          None,             None,
    (0x072B,),        None,               (0x0701,),        None,
    (0x0725,),        (0x0710,),          (0x0735,),        (0x071B, 0x200D),
    None,             None,               (0x0702,),        None,
    (0x0730,),        (0x0733,),          (0x073A,),        (0x0736,),
    (0x072B,),        None,               (0x073D,),        (0x00A0,),
    (0x0735,), (0x0200C, 0x0725, 0x200D), (0x0700,),        (0x0706,),
    None,             (0x071B, 0x200C),   None,             None,
    None,             (0x0730,),          (0x0712, 0x200D), None,
    (0x0716,),        (0x0736,),          (0x0733,),        (0x0713, 0x200D),
    None,             (0x073A,),          None,             (0x071F, 0x200D),
    (0x0720, 0x200D), (0x0721, 0x200D),   (0x0722, 0x200D), (0x200D, 0x0725, 0x200D),
    (0x0726, 0x200D), (0x0729, 0x200D),   None,             (0x0723, 0x200D),
    None,             (0x073D,),          None,             None,
    (0x071A, 0x200D), (0x071D, 0x200D),   None,             (0x0741,),
    (0x0748,),        (0x0742,),          (0x0735,),        (0x0640,),
    None,             (0x0730,),          (0x0712, 0x200C), (0x0728,),
    (0x0715,),        (0x0736,),          (0x0733,),        (0x0713, 0x200C),
    (0x0717,),        (0x073A,),          None,             (0x071F, 0x200C),
    (0x0720, 0x200C), (0x0721, 0x200C), (0x200C, 0x0722, 0x200C), (0x200D, 0x0722,),
    (0x0726, 0x200C), (0x0729, 0x200C),   (0x072A,),        (0x0723, 0x200C),
    (0x072C,),        (0x073D,),          None,             (0x0718,),
    (0x071A, 0x200C), (0x071D, 0x200C),   (0x0719,),        (0x0741,),
    (0x0748,),        (0x0742,),          None))
