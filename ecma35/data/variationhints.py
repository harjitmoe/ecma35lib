...
applesinglehints = {
    ...
    #
    # Absolute kludges
    (0xF841,): (0x21F9, 0x032C, 0x0302),
    (0xF843,): (0x1F898, 0xF87A),
    (0xF845,): (0x21A2, 0xF87F),
    #
    # Avoiding ASCII semiconvergence, map superscripts to Big5 "small form variants" (horizontal
    #   presentation forms), which IBM's GCGID system does not distinguish from superscript.
    (0x0021, 0xF877): (0xFE57,),
    (0x002A, 0xF877): (0xFE61,),
    (0x003C, 0xF877): (0xFE64,),
    (0x003E, 0xF877): (0xFE65,),
    (0x005B, 0xF877): (0xFE5D,),
    (0x005D, 0xF877): (0xFE5E,),
    (0x007B, 0xF877): (0xFE5B,),
    (0x007D, 0xF877): (0xFE5C,),
    #
    # Remaining ASCII semiconvergence
    (0x0028, 0xF87C): (0xFF08, 0xF87C),
    (0x0028, 0xF87F): (0xFF08, 0xF87F),
    (0x0029, 0xF87C): (0xFF09, 0xF87C),
    (0x0029, 0xF87F): (0xFF09, 0xF87F),
    (0x002D, 0x0308): (0xFF0D, 0x0308),
    (0x003D, 0x20E5): (0xFF1D, 0x20E5),
    (0x005B, 0xF87B): (0xFF3B, 0xF87B),
    (0x005B, 0xF87C): (0xFF3B, 0xF87C),
    (0x005D, 0xF87B): (0xFF3D, 0xF87B),
    (0x005D, 0xF87C): (0xFF3D, 0xF87C),
    #
