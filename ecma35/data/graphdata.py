...
from ecma35.data.singlebyte import ecma6, extlatin, c0substs, dingbats, quoocs_ngwx, ccitt, cyrillic, semitic, greek, indic, otherscript, splitebcdic, pseudographics, kana, fragment, userdefined, operators
...
g94bytes = {tuple(b"@"): ("ir002", # Preferred version
            ...
            tuple(b"B"): ("ir006",
                          ("ir006/overline", "ir006/brvbar", "ir006/pli", "ir006/florin",
                           ...
                           "ir006/pli/unicameral", "ir006/1963", "ir006/smart-quotes-up-arrow",
                           "ir006/angle-brackets-for-braces", "ir006/smartquotes-hybrid"),
                          ("ir006",)),
            ...
            tuple(b"l"): ("ir090/ets",
                          ("ir090/ets", "ir090/ets-alpha", "ir090/afii"),
                          ("ir090",)),
            tuple(b"m"): "ir091",
            tuple(b"n"): "ir092",
            ...
            tuple(b"$9"): ("alt646/icelandic/alt",
            ...
            tuple(b"%4"): ("alt646/ibmquebec", ("alt646/ibmquebec/wp",), ("alt646/ibmquebec",)),
            ...
            tuple(b"&7"): ("alt646/ibmuk", ("alt646/ibmuk/dcf", "alt646/ibmuk/wp"), ("alt646/ibmuk",)),
            ...
            tuple(b"'5"): ("ir234/94",
                           ("ir164/ibm/94",),
                           ("ir164/94", "ir138/94", "ir198/94", "ir234/94")),
            tuple(b"'6"): "ir208/94",
            tuple(b"'7"): "alt646/newpolish",
            tuple(b"'8"): "alt646/ibmafrikaans",
            tuple(b"'9"): ("alt646/ibmczech", ("alt646/ibmczech/small",), ("alt646/ibmczech",)),
            tuple(b"':"): "alt646/ibmslovak",
            tuple(b"';"): "alt646/ibmdutch",
            tuple(b"'<"): "alt646/ibmhongkong",
            tuple(b"'="): ("alt646/ibmromanian",
                           ("alt646/ibmromanian/small",),
                           ("alt646/ibmromanian",)),
            tuple(b"'>"): "square-brackets",
            tuple(b"'?"): "squared-and-cubed",
            tuple(b",0"): "half-and-trema",
            tuple(b",1"): "alt646/ibm-3270-denmark-norway",
            tuple(b",2"): "alt646/ibm-3270-german",
            tuple(b",3"): "alt646/ibm-3270-spanish",
            tuple(b",4"): "alt646/ibm-3270-sweden-finland",
            tuple(b",5"): "alt646/ibm-brazil-wp",
            tuple(b",6"): "alt646/ibm-canada-english-wp",
            tuple(b",7"): "alt646/ibm-greece-wp",
            tuple(b",8"): "alt646/ibm-iceland-wp",
            tuple(b",9"): ("alt646/ibm-japan-wp",
                           ("alt646/ibm-japan-wp/small",),
                           ("alt646/ibm-japan-wp",)),
            tuple(b",:"): "alt646/ibm-latin-america-wp",
            tuple(b",;"): "alt646/ibm-portugal-wp",
            tuple(b",<"): "alt646/ibm-spain-wp",
            tuple(b",="): "alt646/ibm-sweden-finland-wp",
            tuple(b",>"): "alt646/ibm-swiss-french-wp",
            tuple(b",?"): "alt646/ibm-swiss-german-wp",
            tuple(b"!\"0"): "alt646/ibm-switzerland-wp",
            ...
            tuple(b"!\"8"): ("ir227/94", ("ir126/euro/alt/94",), ("ir126/94", "ir126/euro/94", "ir227/94")),
            tuple(b"!\"9"): "ir127/94",
            tuple(b"!\":"): "ir181/94",
            tuple(b"!\";"): "abicomp/94",
            tuple(b"!\"<"): "ibmlao/94",
            tuple(b"!\"="): "ibmarabic/94",
            tuple(b"!\">"): ("ibmaix-arabic/isoextended/94",
                             ("ibmaix-arabic/isoextended/94",),
                             ("ibmaix-arabic/base/94",)),
            tuple(b"!\"?"): ("ibmpc-arabic/base/94",
            ...
            tuple(b"!$3"): "spcaesarea",
            tuple(b"!$4"): "spatlantis",
            tuple(b"!$5"): "spedessa",
            tuple(b"!$6"): "bee",
            tuple(b"!$7"): "tex-ipa-gl/94",
            tuple(b"!$8"): "bookshelf-3",
            tuple(b"!$9"): "bookshelf-1-gl",
            tuple(b"!$:"): "bookshelf-2-gl",
            tuple(b"!$;"): "bookshelf-7-gl",
            tuple(b"!$<"): "georgian-academy/94",
            tuple(b"!$="): "x11-lao",
            tuple(b"!$>"): "hershey-astrological",
...
g96bytes = {tuple(b"@"): "ir111",
            ...
            tuple(b"D"): "ir110",
            tuple(b"E"): "ir123",
            tuple(b"F"): ("ir126/euro", ("ir126/euro", "ir126/euro/alt"), ("ir126",)),
            tuple(b"G"): "ir127",
            tuple(b"H"): "ir138",
            tuple(b"I"): "ir139",
            ...
            tuple(b"M"): ("ir148", ("ir148/azeri",), ("ir148",)),
            tuple(b"N"): "ir152",
            tuple(b"O"): "ir153",
            tuple(b"P"): "ir154",
            tuple(b"Q"): "ir155",
            ...
            tuple(b"\"0"): "tex-supplementary-phonetic",
...
g94nbytes = {tuple(b"@"): ("ir042/nec", ("ir042/ibm", "ir042/nec", "ir042/1990pivot", "ir042/adobe"), ("ir042",)),
             ...
             tuple(b"D"): ("ir159",
                           ("ir159/va", "ir159/osf", "ir159/osfa", "ir159/osfm", "ir159/ibm",
                            "ir159/icueuc", "ir159/later-disunifications"),
                           ("ir159",)),
             ...
             tuple(b"G"): ("ir171/full",
                           ("ir171/full", "ir171/ms", "ir171/utc", "ir171/utcbig5", "ir171/mac", "ir171/govtw", "ir171/ibm", "ir171/ibm950", "ir171/ibm1373", "ir171/web", "ir171/1984moz", "ir171/icu", "ir171/icu-2014", "ir171/yasuoka", "ir171/hkscs2016", "ir171/x11"),
                           ("ir171",)),
             tuple(b"H"): ("ir172",
                           (None, "ir172/big5", None, None, None, "ir172/unihan", "ir172/hkscs2016", "ir172/x11"),
                           ("ir172",)),
             tuple(b"I"): ("ir183/full",
                           ("ir183/1988", "ir183/1988plus", "ir183/govtw/old", "ir183/full", "ir183/utc", "ir183/icu", "ir183/icu-2014", "ir183/yasuoka", "ir183/unihan", "ir183/govtw", "ir183/x11"),
                           ("ir183",)),
             tuple(b"J"): ("ir184", ("ir184/govtw/old", "ir184/icu", "ir184/icu-2014", "ir184/yasuoka", "ir184/unihan", "ir184/govtw"), ("ir184",)),
             tuple(b"K"): ("ir185", ("ir185/govtw/old", "ir185/icu", "ir185/icu-2014", "ir185/yasuoka", "ir185/unihan", "ir185/govtw"), ("ir185",)),
             tuple(b"L"): ("ir186", ("ir186/govtw/old", "ir186/icu", "ir186/icu-2014", "ir186/yasuoka", "ir186/unihan", "ir186/govtw"), ("ir186",)),
             tuple(b"M"): ("ir187", ("ir187/govtw/old", "ir187/icu", "ir187/icu-2014", "ir187/yasuoka", "ir187/unihan", "ir187/govtw"), ("ir187",)),
             tuple(b"N"): ("ir202/full", ("ir202/2003", "ir202/2011", "ir202/full"), ("ir202",)),
             tuple(b"O"): "ir228",
             tuple(b"P"): "ir229",
             tuple(b"Q"): ("ir233", ("ir233/later-disunifications",), ("ir233",)),
             ...
             tuple(b"!2"): ("big5exts/eten/hkscs/updated", ("big5exts/eten/ibm", "big5exts/eten/web", "big5exts/eten/hkscs/gccs/ext", "big5exts/eten/hkscs/1999/updated", "big5exts/eten/hkscs/2001/updated", "big5exts/eten/hkscs/2001/sakura", "big5exts/eten/hkscs/sakura"), ("big5exts/ms", "big5exts/eten/2003", "big5exts/eten", "big5exts/eten/hkscs/gccs", "big5exts/eten/hkscs/1999", "big5exts/eten/hkscs/2001", "big5exts/eten/hkscs/2004", "big5exts/eten/hkscs", "big5exts/eten/hkscs/updated")),
             ...
             tuple(b"!<"): "big5exts/big5e",
             tuple(b"!="): "ksx1002",
             tuple(b"!>"): "ksx1027_1",
             tuple(b"!?"): "ksx1027_2",
             tuple(b"\"0"): ("big5exts/eten/chinasea/aton/old", ("big5exts/eten/chinasea/aton", "big5exts/eten/chinasea/core", "big5exts/eten/chinasea/gothic", "big5exts/eten/chinasea/mincho"), ("big5exts/eten/chinasea/aton/old",)),
             ...
             tuple(b"\"4"): "big5exts/monotype",
             tuple(b"\"5"): "big5exts/eten/plus",
             tuple(b"\"6"): "big5additional/plus",
             tuple(b"\"7"): "big5additional/ibm",
             tuple(b"\"8"): ("sj11239", ("sj11239/babelstonehan",), ("sj11239",)),
             tuple(b"\"9"): ("japan-plane-3", (), ("japan-plane-3",)),
             tuple(b"\":"): ("tcvn5773/extended", (), ("tcvn5773", "tcvn5773/extended")),
             tuple(b"\";"): ("tcvn5773/extended", (), ("tcvn6056", "tcvn5773/extended")),
             tuple(b"\"<"): ("vhn01-row-minus-19", (), ("vhn01-row-minus-19",)),
             tuple(b"\"="): ("vhn02/extended", (), ("vhn02", "vhn02/extended")),
             tuple(b"\">"): ("vhn03", (), ("vhn03",)),
             tuple(b"\"?"): ("ibm-euctw-extension-plane", (), ("ibm-euctw-extension-plane",)),
             tuple(b"#0"): ("csic8", ("csic8/govtw/old", "csic8/govtw"), ("csic8",)),
             tuple(b"#1"): ("csic9", ("csic9/govtw/old", "csic9/govtw"), ("csic9",)),
             tuple(b"#2"): ("csic10", ("csic10/govtw/old",), ("csic10",)),
             tuple(b"#3"): ("csic11", ("csic11/govtw/old", "csic11/govtw"), ("csic11",)),
             tuple(b"#4"): ("csic12", ("csic12/govtw/old", "csic12/govtw"), ("csic12",)),
             tuple(b"#5"): ("csic13-2007",
                            ("csic13-2007/govtw/old", "csic13-2007/govtw"),
                            ("csic13-2007",)),
             tuple(b"#6"): ("csic14-2007",
                            ("csic14-2007/govtw/old", "csic14-2007/govtw"),
                            ("csic14-2007",)),
             tuple(b"#7"): ("csic15",
                            ("csic15/govtw/old", "csic15/icu", "csic15/icu-2014", None,
                             "csic15/unihan", "csic15/govtw"),
                            ("csic15",)),
...
g96nbytes = {tuple(b"!0"):("gbk-nonuro-extras/2022", ("gbk-nonuro-extras/web", "gbk-nonuro-extras/full", "gbk-nonuro-extras/2022"), ("gbk-nonuro-extras",)),
             tuple(b"!1"): ("cccii", ("cccii/koha", "cccii/eacc/hk", "cccii", "cccii/eacc",), ("cccii/eacc/loc",)),
             tuple(b"~"): "nil"}
