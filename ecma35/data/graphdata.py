...
g94bytes = {tuple(b"@"): ("ir002", # Preferred version
            ...
            tuple(b"M"): "ir039",
            tuple(b"N"): "ir037",
            tuple(b"O"): ("ir038ext", ("ir038ext",), ("ir038",)),
            tuple(b"P"): ("ir053ext", ("ir053ext",), ("ir053",)),
            tuple(b"Q"): "ir054",
            tuple(b"R"): "ir025",
            tuple(b"S"): "ir055",
            tuple(b"T"): "ir057",
...
g94nbytes = {tuple(b"@"): ("ir042nec", ("ir042ibm", "ir042nec", "ir042", "ir042adobe"), ("ir042stricter",)),
             ...
             tuple(b"B"): ("ir168web",
                           ("ir168web", "ir168mac", "ir168macps", "ir168mackt6", "ir168utc",
                            ...
                            "ir087fujitsu", "ir168arib", "ir168mac-raw", "ir168macps-raw"),
                           ("ir087", "ir168")),
             ...
             tuple(b"F"): "ir169",
             tuple(b"G"): ("ir171",
                           ("ir171", "ir171-ms", "ir171-utc", "ir171-utcbig5", "ir171-mac", "ir171-govtw", "ir171-ibm", "ir171-ibm950", "ir171-ibm1373", "ir171-web", "ir171-1984moz", "ir171-icu", "ir171-icu-2014", "ir171-yasuoka"),
                           ("ir171",)),
             tuple(b"H"): ("ir172",
                           (None, "ir172-big5", None, None, None),
                           ("ir172",)),
             tuple(b"I"): ("ir183-full",
                           ("ir183-1988", "ir183-1988plus", "ir183", "ir183-full", "ir183-utc", "ir183-icu", "ir183-icu-2014", "ir183-yasuoka"),
                           ("ir183-1992",)),
             ...
             tuple(b"!1"): ("cns-eucg2", ("cns-eucg2-ibm", "cns-eucg2-ms", "cns-eucg2-mac", "cns-eucg2-govtw", "cns-eucg2-icu-old", "cns-eucg2-icu-2014", "cns-eucg2-yasuoka"), ("cns-eucg2",)),
