...
if not os.path.exists(cachefile):
    gcc_sequences = {
        ...
        r"رضي الله عنهما": r"﵄",
        r"رضي الله عنهن": r"﵅",
        r"صلى الله عليه وآله": r"﵆",
        r"عليه السلام": r"﵇",
        r"عليهم السلام": r"﵈",
        r"عليهما السلام": r"﵉",
        r"عليه الصلاة والسلام": r"﵊",
        r"قدس سره": r"﵋",
        r"صلى الله عليه وآله وسلم": r"﵌",
        r"عليها السلام": r"﵍",
        r"تبارك وتعالى": r"﵎",
        r"رحمهم الله": r"﵏",
        # And also likewise with the additional honourific ligatures added in Unicode 17:
        r"جل وعلا": r"﯃",
        r"دامت بركاتهم": r"﯄",
        r"رحمة الله تعالى عليه": r"﯅",
        r"رحمة الله عليهم": r"﯆",
        r"رحمة الله عليهما": r"﯇",
        r"رحمهم الله تعالى": r"﯈",
        r"رحمهما الله": r"﯉",
        r"رحمهما الله تعالى": r"﯊",
        r"رضى الله تعالى عنهم": r"﯋",
        r"حفظه الله": r"﯌",
        r"حفظه الله تعالى": r"﯍",
        r"حفظهم الله تعالى": r"﯎",
        r"حفظهما الله تعالى": r"﯏",
        r"صلى الله تعالى عليه وسلم": r"﯐",
        r"عجل الله فرجه الشريف": r"﯑",
        r"عليه الرحمه": r"﯒",
        r"رحمة الله عليه": r"﶐",
        r"رحمة الله عليها": r"﶑",
        r"رحمه الله تعالى": r"﷈",
        r"رضي الله تعالى عنه": r"﷉",
        r"رضي الله تعالى عنها": r"﷊",
        r"رضي الله تعالى عنهما": r"﷋",
        r"صلى الله عليه وعلى اله وسلم": r"﷌",
        r"عجل الله تعالى فرجه الشريف": r"﷍",
        r"کرم الله وجهه": r"﷎",
        r"عليها الصلاة والسلام": r"𐻑",
        r"عليهم الصلاة والسلام": r"𐻒",
        r"عليهما الصلاة والسلام": r"𐻓",
        r"قدس الله سره": r"𐻔",
        r"قدس سرهم": r"𐻕",
        r"قدس سرهما": r"𐻖",
        r"قدست اسرارهم": r"𐻗",
        ...
        'SSS': '🝜', '🜄F': '🜅', '🜄R': '🜆',
        # Joining ligatures which do not decompose:
        "VY": "Ꝡ", "vy": "ꝡ", "AY": "Ꜽ", "ay": "ꜽ", "AV": "Ꜹ", "av": "ꜹ", "AU": "Ꜷ", "au": "ꜷ",
        "AO": "Ꜵ", "ao": "ꜵ", "AA": "Ꜳ", "aa": "ꜳ", "OO": "Ꝏ", "oo": "ꝏ", "TƷ": "Ꜩ", "tʒ": "ꜩ",
        "lʒ": "ɮ", "dz": "ʣ", "dʒ": "ʤ", "dʑ": "ʥ", "ts": "ʦ", "tʃ": "ʧ", "tɕ": "ʨ", "fŋ": "ʩ",
        "ls": "ʪ", "lz": "ʫ", "dʐ": "ꭦ", "tʂ": "ꭧ", "OE": "Œ", "oe": "œ", "AE": "Æ", "ae": "æ",
        "əo": "ᴔ", "ɔe": "ꭢ", "əø": "ꭁ", "əɵ": "ꭂ", "ᴬᴬ": "𐞀", "ᵃᵉ": "𐞃", "ᵈᶻ": "𐞇", "ᵈᶼ": "𐞈",
        "ᵈᶽ": "𐞉", "ᵈᶾ": "𐞊", "ᶠᵑ": "𐞐", "ˡˢ": "𐞙", "ˡᶻ": "𐞚", "ˡᶾ": "𐞞", "ᴼᴱ": "𐞣", "ᵗᶝ": "𐞫", "ᵗˢ": "𐞬",
        "ᵗᶴ": "𐞮", "LL": "Ỻ", "ll": "ỻ", "lb": "℔", "A/S": "⅍", "ɭʒ": "𝼅", "ᶩᶾ": "𐞟", "d𝼘": "𝼒",
