...
graphdata.gsets["ir149/unihan"] = (94, 2, parsers.fuse([
    parsers.read_unihan_planes("UCD/Unihan_IRGSources-18alpha.txt", "kIRG_KSource", "K0"),
...
# KS X 1002.
ksx1002_hanja = parsers.read_unihan_planes("UCD/Unihan_IRGSources-18alpha.txt", "kIRG_KSource", "K1")
...
ksx1027_1_unihan = parsers.read_unihan_planes("UCD/Unihan_IRGSources-18alpha.txt", "kIRG_KSource", "K2")
...
ksx1027_2_hanja = parsers.read_unihan_planes("UCD/Unihan_IRGSources-18alpha.txt", "kIRG_KSource", "K3")
