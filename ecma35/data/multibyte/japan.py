...
graphdata.gsets["ir168mac"] = jisx0208_apple = (94, 2, parsers.read_main_plane("sjis_mac_std9_0208part.txt", mapper = parsers.ahmap))
graphdata.gsets["ir168macps"] = jisx0208_appleps = (94, 2, parsers.read_main_plane("sjis_mac_ps_0208part.txt", mapper = parsers.ahmap))
