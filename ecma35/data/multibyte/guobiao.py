...
graphdata.gsets["gb13131-irgn2376"] = (94, 2, parsers.fuse([
        parsers.read_unihan_planes("UCD/Unihan_IRGSources-16.txt", "kIRG_GSource", "G3"),
...
graphdata.gsets["gb13132-irgn2376"] = (94, 2, parsers.fuse([
        parsers.read_unihan_planes("UCD/Unihan_IRGSources-16.txt", "kIRG_GSource", "G5"),
        ...
        (None,) * ((94 * (16 - 1)) + 8 - 1) + ((0x2219A,),),
        (None,) * ((94 * (16 - 1)) + 9 - 1) + ((0x231C7,),),
        (None,) * ((94 * (16 - 1)) + 12 - 1) + ((0x23343,),),
        (None,) * ((94 * (16 - 1)) + 13 - 1) + ((0x596D,),),
        (None,) * ((94 * (16 - 1)) + 15 - 1) + ((0x308C2,),),
        (None,) * ((94 * (16 - 1)) + 16 - 1) + ((0x31C31,),),
        (None,) * ((94 * (16 - 1)) + 17 - 1) + ((0x2219F,),),
        (None,) * ((94 * (16 - 1)) + 18 - 1) + ((0x24CC5,),),
        (None,) * ((94 * (16 - 1)) + 20 - 1) + ((0x21647,),),
        (None,) * ((94 * (16 - 1)) + 21 - 1) + ((0x269A7,),),
        (None,) * ((94 * (16 - 1)) + 22 - 1) + ((0x23C53,),),
        (None,) * ((94 * (16 - 1)) + 27 - 1) + ((0x21FE8,),),
        (None,) * ((94 * (16 - 1)) + 35 - 1) + ((0x269FF,),),
        (None,) * ((94 * (16 - 1)) + 38 - 1) + ((0x20984,),),
        (None,) * ((94 * (16 - 1)) + 40 - 1) + ((0x209AA,),),
        (None,) * ((94 * (16 - 1)) + 42 - 1) + ((0x209AB,),),
        (None,) * ((94 * (16 - 1)) + 43 - 1) + ((0x3017B,),),
        (None,) * ((94 * (16 - 1)) + 44 - 1) + ((0x20DDE,),),
        (None,) * ((94 * (16 - 1)) + 45 - 1) + ((0x2235A,),),
        (None,) * ((94 * (16 - 1)) + 49 - 1) + ((0x20A34,),),
        (None,) * ((94 * (16 - 1)) + 56 - 1) + ((0x2BA06,),),
        (None,) * ((94 * (16 - 1)) + 57 - 1) + ((0x20A4F,),),
        (None,) * ((94 * (16 - 1)) + 63 - 1) + ((0x20A69,),),
        (None,) * ((94 * (16 - 1)) + 64 - 1) + ((0x20A6B,),),
        (None,) * ((94 * (16 - 1)) + 66 - 1) + ((0x20A7A,),),
        (None,) * ((94 * (16 - 1)) + 67 - 1) + ((0x20A86,),),
        (None,) * ((94 * (16 - 1)) + 69 - 1) + ((0x20A87,),),
        (None,) * ((94 * (16 - 1)) + 72 - 1) + ((0x20A8A,),),
        (None,) * ((94 * (16 - 1)) + 74 - 1) + ((0x20A99,),),
        (None,) * ((94 * (16 - 1)) + 75 - 1) + ((0x20A9A,),),
        (None,) * ((94 * (16 - 1)) + 76 - 1) + ((0x21855,),),
        (None,) * ((94 * (16 - 1)) + 77 - 1) + ((0x20AAE,),),
        (None,) * ((94 * (16 - 1)) + 79 - 1) + ((0x24BCD,),),
        (None,) * ((94 * (16 - 1)) + 80 - 1) + ((0x2774F,),),
        (None,) * ((94 * (16 - 1)) + 83 - 1) + ((0x29D23,),),
        (None,) * ((94 * (16 - 1)) + 84 - 1) + ((0x2751E,),),
        (None,) * ((94 * (16 - 1)) + 87 - 1) + ((0x21B50,),),
        (None,) * ((94 * (16 - 1)) + 89 - 1) + ((0x21420,),),
        (None,) * ((94 * (16 - 1)) + 90 - 1) + ((0x20930,),),
        (None,) * ((94 * (16 - 1)) + 93 - 1) + ((0x268DE,),),
        (None,) * ((94 * (16 - 1)) + 94 - 1) + ((0x20934,),),
        (None,) * ((94 * (17 - 1)) + 2 - 1) + ((0x2721F,),),
        (None,) * ((94 * (17 - 1)) + 3 - 1) + ((0x2093C,),),
        (None,) * ((94 * (17 - 1)) + 8 - 1) + ((0x20966,),),
        (None,) * ((94 * (17 - 1)) + 9 - 1) + ((0x209D9,),),
        (None,) * ((94 * (17 - 1)) + 10 - 1) + ((0x209DE,),),
        (None,) * ((94 * (17 - 1)) + 11 - 1) + ((0x209E9,),),
        (None,) * ((94 * (17 - 1)) + 14 - 1) + ((0x209EA,),),
        (None,) * ((94 * (17 - 1)) + 15 - 1) + ((0x209F4,),),
        (None,) * ((94 * (17 - 1)) + 16 - 1) + ((0x79BC,),),
        (None,) * ((94 * (17 - 1)) + 17 - 1) + ((0x2053C,),),
        (None,) * ((94 * (17 - 1)) + 24 - 1) + ((0x2052F,),),
        (None,) * ((94 * (17 - 1)) + 31 - 1) + ((0x4FB4,),),
        (None,) * ((94 * (17 - 1)) + 32 - 1) + ((0x203B3,),),
        (None,) * ((94 * (17 - 1)) + 33 - 1) + ((0x2B8DB,),),
        (None,) * ((94 * (17 - 1)) + 35 - 1) + ((0x24D18,),),
        (None,) * ((94 * (17 - 1)) + 37 - 1) + ((0x204F7,),),
        (None,) * ((94 * (17 - 1)) + 61 - 1) + ((0x201B6,),),
        (None,) * ((94 * (17 - 1)) + 63 - 1) + ((0x201F1,),),
        (None,) * ((94 * (17 - 1)) + 70 - 1) + ((0x2B894,),),
        (None,) * ((94 * (17 - 1)) + 75 - 1) + ((0x201D7,),),
        (None,) * ((94 * (17 - 1)) + 77 - 1) + ((0x2045F,),),
        (None,) * ((94 * (17 - 1)) + 78 - 1) + ((0x2B898,),),
        (None,) * ((94 * (17 - 1)) + 86 - 1) + ((0x203C0,),),
        (None,) * ((94 * (17 - 1)) + 87 - 1) + ((0x20236,),),
        (None,) * ((94 * (18 - 1)) + 7 - 1) + ((0x20231,),),
        (None,) * ((94 * (18 - 1)) + 24 - 1) + ((0x2026B,),),
        (None,) * ((94 * (18 - 1)) + 27 - 1) + ((0x20263,),),
        (None,) * ((94 * (18 - 1)) + 28 - 1) + ((0x2026A,),),
        (None,) * ((94 * (18 - 1)) + 29 - 1) + ((0x202A7,),),
        (None,) * ((94 * (18 - 1)) + 40 - 1) + ((0x202AC,),),
        (None,) * ((94 * (18 - 1)) + 42 - 1) + ((0x202AB,),),
        (None,) * ((94 * (18 - 1)) + 46 - 1) + ((0x203EC,),),
        (None,) * ((94 * (18 - 1)) + 49 - 1) + ((0x202FA,),),
        (None,) * ((94 * (18 - 1)) + 66 - 1) + ((0x203B8,),),
        (None,) * ((94 * (18 - 1)) + 68 - 1) + ((0x2037D,),),
        (None,) * ((94 * (18 - 1)) + 70 - 1) + ((0x2033C,),),
        (None,) * ((94 * (18 - 1)) + 74 - 1) + ((0x20377,),),
        (None,) * ((94 * (18 - 1)) + 75 - 1) + ((0x203AE,),),
        (None,) * ((94 * (18 - 1)) + 76 - 1) + ((0x20421,),),
        (None,) * ((94 * (18 - 1)) + 77 - 1) + ((0x20379,),),
        (None,) * ((94 * (18 - 1)) + 83 - 1) + ((0x203B7,),),
        (None,) * ((94 * (18 - 1)) + 84 - 1) + ((0x203E1,),),
        (None,) * ((94 * (18 - 1)) + 89 - 1) + ((0x2B8EB,),),
        (None,) * ((94 * (18 - 1)) + 92 - 1) + ((0x203EB,),),
        (None,) * ((94 * (19 - 1)) + 1 - 1) + ((0x203EF,),),
        (None,) * ((94 * (19 - 1)) + 2 - 1) + ((0x20424,),),
        (None,) * ((94 * (19 - 1)) + 3 - 1) + ((0x20458,),),
        (None,) * ((94 * (19 - 1)) + 5 - 1) + ((0x300C6,),),
        (None,) * ((94 * (19 - 1)) + 8 - 1) + ((0x2046A,),),
        (None,) * ((94 * (19 - 1)) + 16 - 1) + ((0x208D8,),),
        (None,) * ((94 * (19 - 1)) + 19 - 1) + ((0x208DF,),),
        (None,) * ((94 * (19 - 1)) + 20 - 1) + ((0x208E4,),),
        (None,) * ((94 * (19 - 1)) + 21 - 1) + ((0x208EE,),),
        (None,) * ((94 * (19 - 1)) + 22 - 1) + ((0x208F9,),),
        (None,) * ((94 * (19 - 1)) + 23 - 1) + ((0x208F5,),),
        (None,) * ((94 * (19 - 1)) + 25 - 1) + ((0x208FE,),),
        (None,) * ((94 * (19 - 1)) + 26 - 1) + ((0x20904,),),
        (None,) * ((94 * (19 - 1)) + 27 - 1) + ((0x2090F,),),
        (None,) * ((94 * (19 - 1)) + 28 - 1) + ((0x22EB5,),),
        (None,) * ((94 * (19 - 1)) + 29 - 1) + ((0x20917,),),
        (None,) * ((94 * (19 - 1)) + 31 - 1) + ((0x29C21,),),
        (None,) * ((94 * (19 - 1)) + 32 - 1) + ((0x29C22,),),
        (None,) * ((94 * (19 - 1)) + 33 - 1) + ((0x20926,),),
        (None,) * ((94 * (19 - 1)) + 34 - 1) + ((0x3563,),),
        (None,) * ((94 * (19 - 1)) + 37 - 1) + ((0x20646,),),
        (None,) * ((94 * (19 - 1)) + 38 - 1) + ((0x31196,),),
        (None,) * ((94 * (19 - 1)) + 39 - 1) + ((0x20633,),),
        (None,) * ((94 * (19 - 1)) + 43 - 1) + ((0x20648,),),
        (None,) * ((94 * (19 - 1)) + 47 - 1) + ((0x2A70E,),),
        (None,) * ((94 * (19 - 1)) + 48 - 1) + ((0x27643,),),
        (None,) * ((94 * (19 - 1)) + 52 - 1) + ((0x27669,),),
        (None,) * ((94 * (19 - 1)) + 54 - 1) + ((0x2016C,),),
        (None,) * ((94 * (19 - 1)) + 55 - 1) + ((0x27C04,),),
        (None,) * ((94 * (19 - 1)) + 56 - 1) + ((0x276A4,),),
        (None,) * ((94 * (19 - 1)) + 59 - 1) + ((0x2368F,),),
        (None,) * ((94 * (19 - 1)) + 62 - 1) + ((0x224B2,),),
        (None,) * ((94 * (19 - 1)) + 63 - 1) + ((0x27708,),),
        (None,) * ((94 * (19 - 1)) + 65 - 1) + ((0x205B9,),),
        (None,) * ((94 * (19 - 1)) + 67 - 1) + ((0x205CA,),),
        (None,) * ((94 * (19 - 1)) + 68 - 1) + ((0x51B8,),),
        (None,) * ((94 * (19 - 1)) + 70 - 1) + ((0x205C3,),),
        (None,) * ((94 * (19 - 1)) + 73 - 1) + ((0x205C2,),),
        (None,) * ((94 * (19 - 1)) + 78 - 1) + ((0x205E8,),),
        (None,) * ((94 * (19 - 1)) + 82 - 1) + ((0x2B938,),),
        (None,) * ((94 * (19 - 1)) + 88 - 1) + ((0x20A18,),),
        (None,) * ((94 * (19 - 1)) + 90 - 1) + ((0x20A0E,),),
        (None,) * ((94 * (19 - 1)) + 92 - 1) + ((0x206A5,),),
        (None,) * ((94 * (19 - 1)) + 93 - 1) + ((0x206AA,),),
        (None,) * ((94 * (20 - 1)) + 1 - 1) + ((0x225AB,),),
        (None,) * ((94 * (20 - 1)) + 4 - 1) + ((0x20735,),),
        (None,) * ((94 * (20 - 1)) + 7 - 1) + ((0x207C8,),),
        (None,) * ((94 * (20 - 1)) + 12 - 1) + ((0x23B0E,),),
        (None,) * ((94 * (20 - 1)) + 14 - 1) + ((0x3011A,),),
        (None,) * ((94 * (20 - 1)) + 16 - 1) + ((0x206B7,),),
        (None,) * ((94 * (20 - 1)) + 17 - 1) + ((0x206BC,),),
        (None,) * ((94 * (20 - 1)) + 19 - 1) + ((0x206D0,),),
        (None,) * ((94 * (20 - 1)) + 24 - 1) + ((0x206CE,),),
        (None,) * ((94 * (20 - 1)) + 25 - 1) + ((0x20783,),),
        (None,) * ((94 * (20 - 1)) + 28 - 1) + ((0x2B97C,),),
        (None,) * ((94 * (20 - 1)) + 30 - 1) + ((0x206EA,),),
        (None,) * ((94 * (20 - 1)) + 31 - 1) + ((0x20719,),),
        (None,) * ((94 * (20 - 1)) + 32 - 1) + ((0x20710,),),
        (None,) * ((94 * (20 - 1)) + 33 - 1) + ((0x2B981,),),
        (None,) * ((94 * (20 - 1)) + 34 - 1) + ((0x20716,),),
        (None,) * ((94 * (20 - 1)) + 35 - 1) + ((0x20718,),),
        (None,) * ((94 * (20 - 1)) + 38 - 1) + ((0x2075F,),),
        (None,) * ((94 * (20 - 1)) + 39 - 1) + ((0x2073B,),),
        (None,) * ((94 * (20 - 1)) + 41 - 1) + ((0x20736,),),
        (None,) * ((94 * (20 - 1)) + 42 - 1) + ((0x20731,),),
        (None,) * ((94 * (20 - 1)) + 44 - 1) + ((0x2073E,),),
        (None,) * ((94 * (20 - 1)) + 48 - 1) + ((0x20769,),),
        (None,) * ((94 * (20 - 1)) + 49 - 1) + ((0x2075D,),),
        (None,) * ((94 * (20 - 1)) + 54 - 1) + ((0x2078A,),),
        (None,) * ((94 * (20 - 1)) + 55 - 1) + ((0x2B989,),),
        (None,) * ((94 * (20 - 1)) + 56 - 1) + ((0x20789,),),
        (None,) * ((94 * (20 - 1)) + 57 - 1) + ((0x20763,),),
        (None,) * ((94 * (20 - 1)) + 58 - 1) + ((0x20788,),),
        (None,) * ((94 * (20 - 1)) + 61 - 1) + ((0x20787,),),
        (None,) * ((94 * (20 - 1)) + 62 - 1) + ((0x20784,),),
        (None,) * ((94 * (20 - 1)) + 63 - 1) + ((0x207AE,),),
        (None,) * ((94 * (20 - 1)) + 68 - 1) + ((0x207CE,),),
        (None,) * ((94 * (20 - 1)) + 69 - 1) + ((0x207CD,),),
        (None,) * ((94 * (20 - 1)) + 70 - 1) + ((0x207C3,),),
        (None,) * ((94 * (20 - 1)) + 72 - 1) + ((0x207C9,),),
        (None,) * ((94 * (20 - 1)) + 74 - 1) + ((0x207E8,),),
        (None,) * ((94 * (20 - 1)) + 75 - 1) + ((0x2082F,),),
        (None,) * ((94 * (20 - 1)) + 76 - 1) + ((0x207FA,),),
        (None,) * ((94 * (20 - 1)) + 77 - 1) + ((0x20817,),),
        (None,) * ((94 * (20 - 1)) + 80 - 1) + ((0x27D25,),),
        (None,) * ((94 * (20 - 1)) + 81 - 1) + ((0x20843,),),
        (None,) * ((94 * (20 - 1)) + 87 - 1) + ((0x2086D,),),
        (None,) * ((94 * (20 - 1)) + 89 - 1) + ((0x2C743,),),
        (None,) * ((94 * (20 - 1)) + 91 - 1) + ((0x208A5,),),
        (None,) * ((94 * (20 - 1)) + 93 - 1) + ((0x20895,),),
        (None,) * ((94 * (21 - 1)) + 5 - 1) + ((0x208B2,),),
        (None,) * ((94 * (21 - 1)) + 8 - 1) + ((0x208CA,),),
        (None,) * ((94 * (21 - 1)) + 13 - 1) + ((0x21284,),),
        (None,) * ((94 * (21 - 1)) + 14 - 1) + ((0x290F6,),),
        (None,) * ((94 * (21 - 1)) + 15 - 1) + ((0x290F7,),),
        (None,) * ((94 * (21 - 1)) + 16 - 1) + ((0x28812,),),
        (None,) * ((94 * (21 - 1)) + 17 - 1) + ((0x235A4,),),
        (None,) * ((94 * (21 - 1)) + 18 - 1) + ((0x253F3,),),
        (None,) * ((94 * (21 - 1)) + 19 - 1) + ((0x2375C,),),
        (None,) * ((94 * (21 - 1)) + 20 - 1) + ((0x237FC,),),
        (None,) * ((94 * (21 - 1)) + 23 - 1) + ((0x20B38,),),
        (None,) * ((94 * (21 - 1)) + 28 - 1) + ((0x264BA,),),
        (None,) * ((94 * (21 - 1)) + 29 - 1) + ((0x20B57,),),
        (None,) * ((94 * (21 - 1)) + 30 - 1) + ((0x20B65,),),
        (None,) * ((94 * (21 - 1)) + 31 - 1) + ((0x20B6F,),),
        (None,) * ((94 * (21 - 1)) + 32 - 1) + ((0x20B74,),),
        (None,) * ((94 * (21 - 1)) + 34 - 1) + ((0x20B89,),),
        (None,) * ((94 * (21 - 1)) + 35 - 1) + ((0x20B8C,),),
        (None,) * ((94 * (21 - 1)) + 36 - 1) + ((0x243FB,),),
        (None,) * ((94 * (21 - 1)) + 37 - 1) + ((0x20B90,),),
        (None,) * ((94 * (21 - 1)) + 38 - 1) + ((0x2231A,),),
