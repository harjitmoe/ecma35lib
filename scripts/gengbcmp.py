...
annots = {
    ...
    (0, 90, 30): "This character is mapped to Unicode as U+4FB4 (侴; compare 02-18-93) in the ICU mapping data, although its reference glyph (which matches 04-17-31 in all charts; unregistered BabelStone IVS U+4FB4+E0101) does not entirely match U+4FB4's reference glyph (although it is a very minor variant).&ensp; However, it <a href=\"https://hc.jsecs.org/irg/ws2024/app/?id=00266\">may be disunified as a CJK Extension K character in a future Unicode version</a>.",
    ...
    (2, 18, 93): "Compare 00-90-30 and 04-17-31.",
    (4, 17, 31): "Compare 02-18-93; see remarks at 00-90-30.",
