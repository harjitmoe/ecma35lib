...
annots = {
    ...
    (1, 1, 77): 'Ω-01-76 and Ω-01-78 are changed to fullwidth square brackets in IBM-933 (since '
                ...
                'row before this point.&ensp;The existing not-equals sign was evidently not '
                'considered a match.',
